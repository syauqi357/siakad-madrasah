...
- **Option A: Direct Link (Simple)**
  ...
  - _Pros:_ Easy to query.
  - _Cons:_ Cannot track history. When a student moves to Class XI, the record of them being in Class X is lost.
...
- **Option B: History Table (Recommended)**
  ...
  - _Pros:_ Complete academic history. Essential for generating transcripts later.
