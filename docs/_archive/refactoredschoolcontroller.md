...
- **`findLogoFile()`**:
  ...
  - _Logic moved from controller._
...
3.  **Maintainability**: The code is cleaner and easier to read. The controller tells you _what_ is happening, and the service tells you _how_ it is happening.
