...
CREATE TABLE `__new_school_facilities` (
	...
	`createdAt` integer DEFAULT 1769653606489
);
--> statement-breakpoint
...
ALTER TABLE `rombel_students` ADD `left_at` text;