<script lang="ts">
	...
	const studentData: Student[] = [
		{ id: 1, nama: "Ahmad Rizki", kelas: "XII RPL 1", jenisKelamin: "L", asal: "Jakarta", status: "aktif" },
		{ id: 2, nama: "Siti Nurhaliza", kelas: "XI TKJ 2", jenisKelamin: "P", asal: "Bandung", status: "aktif" },
		{ id: 3, nama: "Budi Santoso", kelas: "X MM 1", jenisKelamin: "L", asal: "Surabaya", status: "warning" },
		{ id: 4, nama: "Dewi Lestari", kelas: "XII AK 3", jenisKelamin: "P", asal: "Yogyakarta", status: "aktif" },
		{ id: 5, nama: "Eko Prasetyo", kelas: "XI RPL 2", jenisKelamin: "L", asal: "Semarang", status: "nonaktif" },
		{ id: 6, nama: "Fitri Handayani", kelas: "XII TKJ 1", jenisKelamin: "P", asal: "Malang", status: "aktif" },
		{ id: 7, nama: "Gilang Ramadhan", kelas: "X RPL 3", jenisKelamin: "L", asal: "Bogor", status: "warning" },
		{ id: 8, nama: "Hana Safira", kelas: "XI AK 1", jenisKelamin: "P", asal: "Depok", status: "aktif" },
		{ id: 9, nama: "Indra Gunawan", kelas: "XII MM 2", jenisKelamin: "L", asal: "Tangerang", status: "nonaktif" },
		{ id: 10, nama: "Julia Kartika", kelas: "X TKJ 1", jenisKelamin: "P", asal: "Bekasi", status: "aktif" }
	];
...
{#if student}
	<div class="min-h-screen bg-slate-50 p-4 md:p-8">
		<div class="mx-auto max-w-4xl">
			...
			<a 
				href="/"
				class="mb-6 inline-flex items-center gap-2 text-blue-600 hover:text-blue-800"
			>
				← Kembali ke daftar
			</a>
			...
			<div class="rounded-lg bg-white p-6 shadow-lg md:p-8">
				<div class="mb-6 flex items-start justify-between">
					...
					<span class={`rounded-lg border px-4 py-2 text-sm font-medium ${getStatusStyle(student.status)}`}>
