			...
			{#each rombelData as rombel}
				...
				>
					...
					<button
						...
						class="mt-3 flex w-full cursor-pointer items-center justify-center gap-2 rounded-md bg-green-600 px-3 py-2 text-sm font-medium text-white transition-colors hover:bg-green-700 disabled:cursor-not-allowed disabled:bg-green-400"
					>
