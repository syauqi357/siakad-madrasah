										...
										<tr class="transition-colors duration-150 hover:bg-gray-50">
											...
											<td class="px-6 py-4">
												{#if teacher.gender === 'male'}
													<span
														class="inline-flex items-center rounded-md bg-blue-100 px-2.5 py-0.5 text-xs font-semibold text-blue-700"
													>
														L
													</span>
												{:else if teacher.gender === 'female'}
													<span
														class="inline-flex items-center rounded-md bg-pink-100 px-2.5 py-0.5 text-xs font-semibold text-pink-700"
													>
														P
													</span>
												{:else}
				...
				<div class="w-full overflow-hidden rounded-xl border border-gray-300 bg-white">
					...
					<form on:submit|preventDefault={handleSubmit} class="p-6">
						<div class="grid gap-4 md:grid-cols-2">
							...
							<!-- Jenis Kelamin -->
							<div>
								<label class="mb-1 block text-sm font-medium text-gray-700" for="jenis kelamin"
									>Jenis Kelamin</label
								>
